<template>
  <div class="min-h-dvh bg-[#0a0a0a] text-white pb-28">
    ...
    <div class="fixed bottom-0 left-0 right-0 z-40 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/98 to-transparent pb-safe px-4 pt-3">
      <div class="max-w-lg mx-auto">
        ...
        <div class="flex items-center justify-center gap-2 mb-2.5">
          ...
          <span class="text-amber-400/80 text-xs font-medium">已有 <span class="text-amber-400 font-bold">23</span> 位投资人正在关注此剧本</span>
        </div>

        <!-- 主按钮 -->
        <button
          @click="contactOpen = true"
          class="w-full py-4 bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 text-gray-900 font-black text-base rounded-2xl shadow-[0_4px_24px_rgba(245,158,11,0.5)] active:scale-[0.97] transition-all flex items-center justify-center gap-2 mb-2"
        >
          <span class="text-lg">💰</span>
          <span>立即联系 · 洽谈版权合作</span>
        ...
        <!-- 副文字 -->
        <p class="text-center text-gray-600 text-[10px] pb-1">🔒 版权受法律保护 · 签约后提供完整剧本及授权文件</p>
      </div>
    </div>
